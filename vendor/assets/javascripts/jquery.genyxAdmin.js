...
(function($) {
    ...
    $.fn.genyxAdmin = function(options) {
        ...
        var settings = {
            ...
            autoExpandedSub: true, //remeber expanded sub menu by user
        ...
        function mainNav () {
            ...
            if(settings.autoExpandedSub) {
                //auto expanded sub nav if it's activated
                var navCurrentSub = navSub.find('>li.current')
                if(navCurrentSub) {
                    var parentLi = navCurrentSub.parents("li.current");
                    parentLi.find("a.notExpand").click();
                }
            }
       ...
       function setCurrentNav () {
        ...
        // fontFlicker will make turbolinks broken.
        // fontFlicker();
        mainNav();
        setCurrentNav();
        collapseNav();
